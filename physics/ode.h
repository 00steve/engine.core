    ...
    static void NearCallback (void *data, dGeomID o1, dGeomID o2) {
        ...
        if(!nA->Grouped() || !nB->Grouped() || nA->Group() != nB->Group()){
            ...
            if (int numc = dCollide (o1,o2,8,contacts,sizeof(dContactGeom))) {
                ...
                nA->AddCollision(Collision(nB,contacts,numc));
                nB->AddCollision(Collision(nA,contacts,numc));
...
public:
	...
	static void AutoDisable(bool autoDisable){
...
*/
    ...
    static dWorldID WorldId(){ return worldId; }
    static dSpaceID SpaceId(){ return spaceId; }

    static bool Initialized(){ return initialized; }

	static double StepSize(){return stepSize;}
    */
};
